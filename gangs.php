...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Çete Menüsü</h1>
		  <p class="page-header">Panelin çete menüsü, çete veritabanı değerlerini değiştirmenize izin verir.</p>
