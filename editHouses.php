...
?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Evleri Düzenle</h1>
		  <p class="page-header">Panelin evleri düzenle menüsü, değerleri daha derinlemesine değiştirmenizi sağlar.</p>
          <div id="alert-area"></div>
            <div class="table-responsive">
            <table class="table table-striped" style = "margin-top: -10px">
              <thead>
                <tr>
					<th>Konteyner Envanteri</th>
					<th>Konteyner Dişlisi</th>
                    <th>Konteyner Aktif</th>
                    <th>Konteynere Ait</th>
                </tr>
              </thead>
              <tbody>
