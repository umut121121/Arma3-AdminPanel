...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <h1 style = "margin-top: 70px">Oyuncu Menüsü</h1>
    <p class="page-header">Panelin oyuncu menüsü, oyuncuların veritabanı değerlerini değiştirmenize izin verir.</p>
    ...
    switch ($staffPerms) {
        case $staffPerms['ban'] == '1':
            echo "<div class=\"btn-group\" role=\"group\" aria-label=\"...\">
			              ...
			              <INPUT class='btn btn-primary btn-outline' TYPE=\"submit\" VALUE=\"Oyunucuyu Banla\">
		        	      </FORM>
		                  </div>";
        case $staffPerms['unban'] == '1':
            echo "<div class=\"btn-group\" role=\"group\" aria-label=\"...\">
			              <FORM METHOD=\"LINK\" ACTION=\"rCon/unBan.php\">
			              <INPUT class='btn btn-primary btn-outline' TYPE=\"submit\" VALUE=\"Oyuncu unban\">
			              </FORM>
		                  </div>";
        case $staffPerms['kick'] == '1':
            echo "<div class=\"btn-group\" role=\"group\" aria-label=\"...\">
			              <FORM METHOD=\"LINK\" ACTION=\"rCon/Kmenu.php\">
			              <INPUT class='btn btn-primary btn-outline' TYPE=\"submit\" VALUE=\"Oyunucuyu Kickle\">
			              </FORM>
		                  </div>";
        case $staffPerms['notes'] == '1':
            echo "<div class=\"btn-group\" role=\"group\" aria-label=\"...\">
			              <FORM METHOD=\"LINK\" ACTION=\"notes.php\" STYLE = \"display: inline;\">
			              <INPUT class='btn btn-primary btn-outline' TYPE=\"submit\" VALUE=\"Notlar Menüsü\">
			              </FORM>
		                  </div>";
    }
    ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-group">
                        <input type="text" class="form-control" style = "width: 300px;" name="SearchValue" placeholder="Notlar Menüsü/UID/ID...">
    ...
    <div class="table-responsive">
        <table class="table table-striped" style = "margin-top: 0px">
            ...
            <tr>
                ...
                <th>UID</th>
                <th>GUID</th>
                <th><form action = "players.php?search=cash" method="post"><input class='btn-link' type='submit' name='orderCash' value="Oyuncu Nakit"></form></th>
                <th><form action = "players.php?search=bank" method="post"><input class='btn-link' type='submit' name='orderBank' value="Oyuncu Bankası"></form></th>
                <th><form action = "players.php?search=cop" method="post"><input class='btn-link' type='submit' name='orderCop' value="Polis Seviyesi"></form></th>
                <th><form action = "players.php?search=medic" method="post"><input class='btn-link' type='submit' name='orderMedic' value="Doktor Seviyesi"></form></th>
                <th><form action = "players.php?search=admin" method="post"><input class='btn-link' type='submit' name='orderAdmin' value="Admin Seviyesi"></form></th>
                <th>İstatistikler</th>
            </tr>
            </thead>
            <tbody>
            ...
            while ($row = mysqli_fetch_array($search_result, MYSQLI_ASSOC)) {
                ...
                echo '<td>'."<input class='btn btn-primary btn-outline' type=submit name=edit id=edit value=Detaylar".' ></td>';
            ...
            <script>
                ...
                function dbSave(value, uid, column, original){
                    if (value != original) {
                        newAlert('alert-success', 'Değer Güncellendi!');
