...
<h1 style = "margin-top: 70px">Notlar Menüsü</h1>
<p class="page-header">Panelin Notlar Menüsü, oynatıcılar hakkında notlar ayarlamanızı sağlar.</p>
			...
			<div class="row">
			  <div class="col-lg-6">
				<div class="input-group">
				  <input type="text" class="form-control" style = "width: 300px; " name="SearchValue" placeholder="Oyuncu adı/UID/ID...">
...
while ($row = mysqli_fetch_array($search_result, MYSQLI_ASSOC)) {
    ...
    echo '<td>'."<select class='form-control' name='warn'><option value='4'>Commendation</option><option value='1' selected='selected'>Warning</option><option value='2'>Dikkat</option><option value='3'>Büyük Dikkat</option></select> </td>";
...
if (isset($_POST['update'])) {
    ...
    if ($_POST['note'] != $player->note_text) {
        $message = 'Admin '.$user.' notu ekledi ('.$_POST['note'].') -e doğru '.$player->name.'('.$pid.')';
