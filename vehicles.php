...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Araç Menüsü</h1>
		  <p class="page-header">Panelin araç menüsü, araç veritabanı değerlerini değiştirmenizi sağlar.</p><br>
          			  ...
          			  <div class="col-lg-6">
          				<div class="input-group">
          				  ...
          				  <span class="input-group-btn">
          					<input class="btn btn-default" style = "margin-top: 20px;" name="search" type="submit" value="Ara">
          				  </span>
          				</div><!-- /input-group -->
          			  </div><!-- /.col-lg-6 -->
          			</div><!-- /.row -->
