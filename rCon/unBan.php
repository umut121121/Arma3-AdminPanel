...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">UnBan Menü</h1>
		  <p class="page-header">UnBan panelin menüsü, yasaklı oyuncuları yasaklamanıza izin verir.</p>
			...
			<button class="btn btn-primary btn-outline" type="submit">Kontrol battleye list</button>
			</FORM></div> <br><br><br>
...
if (isset($_POST['update'])) {
    ...
    if ($guidUBan != '' and $banid != '') {
        $message = 'Admin '.$user.' yasaklanmamış '.$guidUBan;
        logIt($user, $message, $dbcon);
        header('Location: rcon-unBan.php');
    }
}
?>
<p><br><br><br>Bir oyuncunun banını kaldırmak için Battleye Listesinden ban kimliğini ve oyuncu menüsünden rehberini almanız gerekir!</p>
