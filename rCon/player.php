...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Ban Menü</h1>
		  <p class="page-header">Ban panelin menüsü, oyuncuları yasaklamanıza izin verir.</p>
...
if (isset($_POST['update'])) {
    ...
    if ($whitelist) {
        ...
        $message = 'Admin '.$user.' beyaz listeye alınan bir çalışanı yasaklamaya çalıştı - '.$guid;
        ...
        if ($_POST['guid'] != '') {
            $message = 'Admin '.$user.' yasakladı '.$guid.' için '.$time.' nedeni altında dakikalar ('.$reason.')';
            logIt($user, $message, $dbcon);
