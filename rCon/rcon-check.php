      ...
      <div class="row">
        <div id="navbarside" class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
				...
				<li><a href="../gangs.php">Çeteler</a></li>
				<li><a href="../houses.php">Evler</a></li>
				<li><a href="../logs.php">Loglar</a></li>
                <li><a href="../reimbursement.php">Geri ödeme Loglar</a></li>
				<li><a href="../notesView.php">Notlar</a></li>
				<li><a href="../staff.php">Personel</a></li>
				<li><a href="../Steam/steam.php">Steam Hesapları</a></li>
				<li><a href="../logout.php">Çıkış</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">BattleEye Loglar</h1>
		  <p class="page-header">BattleEye Loglar.</p>
...
if ($debug) {
    ...
    echo 'Oluşturulan sayfa '.$total_time.' saniyeler.';
}
?>
              </tbody>
            </table>
