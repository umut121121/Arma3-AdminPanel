...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <p class="page-header">Bir oyuncuyu sunucudan atma yeteneği verir. Bu, veritabanındaki herhangi bir oyuncu için sunucuya gönderilebilir, açıkçası çevrimdışıysa hiçbir şey olmaz... Çevrimiçi oyuncular için battleye listesini kontrol edin!.</p>
...
if (isset($_POST['update'])) {
    ...
    if ($whitelist) {
        ...
        $message = 'Admin '.$user.' beyaz listeye alınmış bir çalışanı tekmelemeye çalıştı - '.$guid;
        logIt($user, $message, $dbcon);
    } else {
        $name = $_POST['hiddenName'];
        $_SESSION['SKguid'] = $guid;

        $message = 'Admin '.$user.' sunucudan atı '.$player->name.'('.$guid.')';
        logIt($user, $message, $dbcon);
