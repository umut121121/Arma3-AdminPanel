...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <p class="page-header">Battleye Whitelist, komutlara karşı bağışık olan Kılavuzları ekleyin.</p>
...
echo '<form action=whitelist.php method=post>';
  ...
  echo '<td>'."<input class='btn btn-primary btn-outline' type=submit name=update value=Ekle".' </td>';
...
if (isset($_POST['delete'])) {
    ...
    echo '<div class="alert alert-success" role="alert"><a href="#" class="alert-link">Personel REHBERİ silindi!</a></div>';
}
?>
