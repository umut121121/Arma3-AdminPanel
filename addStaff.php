...
if (isset($_POST['update'])) {
    if ($staffPerms['superUser'] == '1') {
        ...
        echo '<div class="alert alert-success" role="alert"><a href="#" class="alert-link">Kullanıcı başarıyla eklendi!</a></div>';
    } else {
        echo '<div class="alert alert-danger" role="alert"><a href="#" class="alert-link">Hayır...</a></div>';
    }
}
?>
