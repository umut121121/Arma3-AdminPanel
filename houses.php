...
<h1 style = "margin-top: 70px">Ev Menüsü</h1>
<p class="page-header">Panelin ev menüsü, ev veritabanı değerlerini değiştirmenize izin verir.</p>
...
while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
    ...
    echo '<td>'."<input class='btn btn-primary btn-outline' type=submit name=edit value=Detaylar".' </td>';
