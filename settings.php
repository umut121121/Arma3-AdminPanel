...
<h1 style = "margin-top: 70px">Ayarlar Menüsü</h1>
    <p class="page-header">Panelin ayarlar menüsü, panel ayarlarını değiştirmenizi sağlar.</p>
<div class='panel panel-info'>
    <div class='panel-heading'>
        <h3 class='panel-title'>Sunucu Bilgisi</h3>
    </div>
